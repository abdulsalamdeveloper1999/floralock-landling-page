          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start space-x-4 my-6">
              <button 
                ...
                className="w-10 h-10 rounded-full border border-gold text-gold font-bold text-xl flex items-center justify-center hover:bg-gold hover:text-white transition-colors"
              >
                -
              </button>
              <input 
